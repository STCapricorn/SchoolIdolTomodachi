    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('art_idol', models.ImageField(upload_to=magi.utils.uploadItem(b'ic'), null=True, verbose_name='Art (Idolized)')),
                ('old_art', models.ImageField(upload_to=magi.utils.uploadItem(b'c'), null=True, verbose_name='Art (Old)')),
                ('old_art_idol', models.ImageField(upload_to=magi.utils.uploadItem(b'ic'), null=True, verbose_name='Art (Old, Idolized)')),
